            ...
            <div className="hidden md:flex space-x-8">
              {["home", "about", "projects", "skills", "education", "contact"].map((section) => (
                <button
                  ...
                  className={`capitalize transition-colors duration-200 hover:text-purple-600 ${activeSection === section ? "text-purple-600" : ""
                    }`}
                >
                  {section}
                </button>
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            ...
            >
              <Button
                ...
                className="px-8 py-3 rounded-full bg-purple-600 hover:bg-purple-700 text-white border-0 transition-all duration-300 transform hover:scale-105 shadow-lg"
              >
              ...
              <Button
                ...
                onClick={() =>
                  window.open(
                    "https://drive.google.com/file/d/1NLZI2DAV9FjAUzBrPmXYuynP4r4lC8h4/view?usp=sharing",
                    "_blank",
                  )
                }
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="relative">
                <Image
                  ...
                  width={500}
                  height={500}
                  className="rounded-2xl shadow-2xl w-full h-auto max-w-md mx-auto object-cover"
                  priority
                />
            ...
            >
              <div className="text-xl text-gray-600 dark:text-gray-300 leading-relaxed space-y-4">
                <p>
                  Hey, I'm <span className="font-bold text-purple-600">Gunit Agarwal</span> an aspiring Data Analyst
                  📊 and Web Developer 💻.
                </p>
                <p>
                  I love turning raw datasets into meaningful stories and complex code into simple, elegant solutions.
                  For me, technology isn't just about solving problems, it's about creating experiences that connect.
                  Every project I take on is an opportunity to learn, grow, and leave a little spark of creativity.
                </p>
                <p>
                  I believe life is a lot like coding full of bugs, errors, and unexpected challenges. But with the
                  right mindset (and a strong cup of coffee ☕), everything can be fixed. Mistakes don't discourage me;
                  they push me to find better solutions. This mindset keeps me motivated, even when the problem seems
                  unsolvable.
                </p>
                <p>
                  My journey is driven by curiosity, creativity, and a belief that learning never stops. I enjoy
                  discovering hidden patterns whether they're buried in messy datasets or inside lines of code.
                  Exploring new tools, experimenting with frameworks, and keeping up with tech trends excites me. I
                  thrive in environments where innovation and problem-solving go hand in hand.
                </p>
                <p>
                  When I'm not coding or analyzing data, I'm probably brainstorming my next project idea. I enjoy
                  imagining "what's next" and how I can use technology to make it real. Got a website that needs a smarter edge? Or data that's just sitting there waiting to tell a story? Lets work on it together I turn numbers into insights and idead to impact.
                </p>
              </div>
            </motion.div>
          </div>
